...
class Engine(EngineScoreMixin, EngineBase):
    ...
    def read_radix_tree(self, max_nodes: int = 1000, include_values: bool = False):
        obj = ReadRadixTreeReq(
            max_nodes=max_nodes,
            include_values=include_values,
        )
        return self.loop.run_until_complete(self.tokenizer_manager.read_radix_tree(obj))
